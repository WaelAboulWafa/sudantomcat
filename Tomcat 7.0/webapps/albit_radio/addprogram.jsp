...
<%
 ...
 InitialContext ic = new InitialContext();
  ...
  int nextid=0;
  ResultSet rs = con.createStatement().executeQuery("SELECT max(id)+1 FROM sms.albit_pgms");            
...
try
{
    ...
    {   
      con.createStatement().execute("insert into  sms.albit_pgms(id, pgm_name,airing_weekday,airing_from,airing_to,replay_weekday,replay_from,replay_to,username,password ) values('" + nextid + "','"+ pgmname + "','"+ pgmairingday +"','" + pgmairingstart + "','" + pgmairingend + "','" + pgmreplayday + "','" + pgmreplaystart + "','" + pgmreplayend + "','" + usrname + "','" + password + "')"); 
      con.close();  
