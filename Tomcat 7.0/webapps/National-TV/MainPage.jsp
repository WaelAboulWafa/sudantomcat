                ...
                <div class="container-fluid">
                    ...
                    <div class="nav-collapse collapse">
                        <ul class="nav pull-right">
                            <li class="dropdown">
                                <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-user"></i> Nat <i class="caret"></i>
            ...
            <div class="row-fluid">
                <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        <li class="active">
                            <a href="MainPage.jsp"><i class="icon-chevron-right"></i> Dashboard iiiiii</a>
                        </li>
                        ...
                        <li >
                            <a href="searchadmin.jsp"><i class="icon-chevron-right"></i>  Tables</a>
                        </li>
                        <li>
