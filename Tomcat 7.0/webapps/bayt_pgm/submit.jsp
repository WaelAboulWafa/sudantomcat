...
//	String thequery ="insert into fitservice.bayt_pgm_smss(Contents,Readable,provider,msisdn,shortcode,lang) values('" + thecontents + "','" + thereadable + "','" + theprovider + "','" +  themsisdn + "','" + theshortcode + "','" + thelang + "')" ;
	String thequery ="insert into fitservice.bayt_pgm_smss(Contents,Readable,provider,msisdn,shortcode,lang) values('" + thecontents + "','','" + theprovider + "','" +  themsisdn + "','" + theshortcode + "','" + thelang + "')" ;
