...
response.sendRedirect("login.jsp");
  ...
  try
  {
   rs = con.createStatement().executeQuery("SELECT count(*) from fitservice.bayt_pgm_Users where username=N'" + username.replaceAll("'", "''") + "' and password=N'" + password.replaceAll("'", "''") + "'");             
   userexit= 0;
...
con.createStatement().execute("update fitservice.bayt_pgm_Users set   lastlogintime= NOW() where username=N'" + username.replaceAll("'", "''") + "' and password=N'" + password.replaceAll("'", "''") + "'");             
