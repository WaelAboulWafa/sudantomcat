...
response.sendRedirect("login.jsp");
  ...
  try
  {
   rs = con.createStatement().executeQuery("SELECT count(*) from fitservice.hawasudan_pgm_Users where username=N'" + username.replaceAll("'", "''") + "' and password=N'" + password.replaceAll("'", "''") + "'");             
   userexit= 0;
...
con.createStatement().execute("update fitservice.hawasudan_pgm_Users set   lastlogintime= NOW() where username=N'" + username.replaceAll("'", "''") + "' and password=N'" + password.replaceAll("'", "''") + "'");             
...
<title>ÏÎÜÜæá ... Hawa AlSudan</title>
</head>
