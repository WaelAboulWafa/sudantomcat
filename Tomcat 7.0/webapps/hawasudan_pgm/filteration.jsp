...
//-----------------------------------
/*String query1 = "SELECT count(*) from fitservice.hawasudan_pgm_smss where flag=0";
String query2 = "SELECT ID from fitservice.hawasudan_pgm_smss where flag=0 order by ID";
String query3 = "select fitservice.hawasudan_pgm_smss.ID,fitservice.hawasudan_pgm_smss.intime, messages.messages.Recipient,messages.messages.Sender, messages.messages.bodyformat,messages.messages.body from  fitservice.hawasudan_pgm_smss INNER JOIN messages.messages  ON fitservice.hawasudan_pgm_smss.ID = messages.messages.id and fitservice.hawasudan_pgm_smss.flag=0 order by fitservice.hawasudan_pgm_smss.ID  asc";
*/

String query1 = "SELECT count(*) from fitservice.hawasudan_pgm_smss where status=0 ";
String query2 = "SELECT ID from fitservice.hawasudan_pgm_smss where status=0 order by ID";
String query3 = "Select ID, datein, shortcode, msisdn, lang, Contents from fitservice.hawasudan_pgm_smss where status=0 order by ID asc";
