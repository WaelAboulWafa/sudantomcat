...
String[] theshortcodes = null;
   ...
   try{
      rs = con.createStatement().executeQuery("SELECT shortcode,count(*) as thecnt FROM router where log =1 and not  ( shortcode in ('87015104','87015024','87015023','87015022','87015021','87015020' ,'87015005','87015002')) group by shortcode asc");            
      while(rs.next())
      {
