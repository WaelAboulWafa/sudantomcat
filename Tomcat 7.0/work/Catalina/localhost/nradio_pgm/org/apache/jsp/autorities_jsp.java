 ...
 * Generated at: 2014-08-13 09:40:51 UTC
...
///-----------------------------------
      ...
      out.write("<title>الصلاحيات ... National Radio</title>\r\n");
      out.write("</head>\r\n");
      out.write("\r\n");
      out.write("<body>\r\n");
      out.write("\r\n");
...
for (int l =0  ; l < theuserid.length ; l ++)
{
  ...
  else
  {
   ...
   while(rs.next()){accusername=rs.getString(1);accpassword=rs.getString(2);accountowner=rs.getString(3);accphone=rs.getString(4);programid=rs.getString(5);}rs.close();rs=null;
      ...
      out.write("\r\n");
      out.write("\t\t      <tr>\r\n");
      out.write("\t\t      <td width='50%' align='center' height='30'><b>رقم البرنامج</b></td>\r\n");
      out.write("<td width='50%' align='center' height='30'><input type='text' name='progid' value='");
      out.print((new String(programid.getBytes("Cp1252"),"Cp1256")));
      out.write("' style='width:14em' size='20'></td>\r\n");
      out.write("\t\t      </tr>\r\n");
      out.write("\r\n");
      out.write("\t\t      <tr>\r\n");
